export const VN = {
    ...
    NuclearPowerPlant: "Nhà máy điện hạt nhân",
    ...
    FuelCostSaveDescV2:
        "Nhà kho tiết kiệm một tỷ lệ nhiên liệu nhất định để vận chuyển tài nguyên so với các công trình khác, cấp độ càng cao thì càng tiết kiệm được nhiều",
    ...
    HideDiscordBanner: "Ẩn biểu ngữ Discord",
    HideDiscordBannerDesc: "Ẩn biểu ngữ Discord trong trụ sở",
    HideChat: "Ẩn khung chat",
    ...
    SuperComputerLab: "Phòng thí nghiệm siêu máy tính",
    SuperComputer: "Siêu máy tính",
    SkyNetInc: "SkyNet Inc",
    SkyNet: "SkyNet",
    RobocarFactory: "Nhà máy Robocar",
    Robocar: "Robocar",
    WarehouseBuildingPermitSave: "Đạo luật cấp phép kho hàng",
    WarehouseBuildingPermitSaveDesc: "Mỗi hai nhà kho cung cấp một giấy phép xây dựng miễn phí",
    PolicySearchPlaceholder: "Nhập tên chính sách để tìm kiếm",
    SwissUpgrade: "Nâng cấp Thụy Sĩ",
    SwissUpgradeDesc: "Nâng cấp Thụy Sĩ là vĩnh viễn và sẽ được kích hoạt khi bạn bắt đầu ở một thành phố mới",
    SwissBoost: "Tăng cường Thụy Sĩ",
    SwissBoostDesc: "Tăng cường Thụy Sĩ chỉ ảnh hưởng đến hoạt động hiện tại của bạn và sẽ được thiết lập lại nếu bạn bắt đầu ở một thành phố mới",
    ProductionMultipliers: "Hệ Số Nhân Sản Xuất",
    MultiplierMapUniqueBonus: "Điểm Thưởng Bản Đồ Riêng Biệt",
    MultiplierSwissUpgrade: "Nâng cấp Thụy Sĩ (Lâu dài)",
    MultiplierSwissBoost: "Tăng cường Thụy Sĩ (Hoạt động này)",
    ...
    HighSpeedWarehouse: "Kho hàng tốc độ cao",
    HighSpeedWarehouseDesc:
        "Kho hàng sẽ có x2 sức chứa và tốc độ vận chuyển vào và ra nhanh hơn 50%, nhưng sử dụng x2 năng lượng",
    ...
    ChipManufacturer: "Nhà máy sản xuất chip",
    SnapTokInc: "SnapTok Inc",
    FaceAppInc: "FaceApp Inc",
    BitcoinMiner: "Máy đào Bitcoin",
    GalvanicBatteryFactory: "Xưởng pin Galvanic",
    BaseProductionMultiplier: "Mức sản xuất gốc",
    ShowBreakdown: "Hiển thị chi tiết",
    HideBreakdown: "Ẩn chi tiết",
    ...
    AchievementCashIsKing: "Tiền mặt là Vua",
    AchievementCashIsKingDesc: "Có 1Qa tiền mặt trong tay trong 1 lần chơi",
    AchievementPowerTycoon: "Ông trùm năng lượng",
    AchievementPowerTycoonDesc: "Tạo ra 1GW năng lượng trong 1 lần chơi",
    PlayerTradeFilteringNResources: "Lọc %{n} tài nguyên",
    PlayerTradeFilterResources: "Bộ lọc tài nguyên",
    PlayerTradeFilterClear: "Xoá bộ lọc",
    ResourceExplorerAll: "Khám phá tất cả các tài nguyên",
    ...
    MetaInc: "Meta Inc",
    ImportSave: "Tải lên bản lưu",
    SaveVersionTooNew:
        "Bản lưu của bạn đang ở phiên bản %{saveVersion} nhưng trò chơi đang ở phiên bản %{gameVersion}. Hãy cập nhật trò chơi",
    LeaderboardByFlag: "Tabluation By Player Flag",
    LeaderboardByMap: "Tabluation By Map",
    LeaderboardByFlagPlayerFlag: "Cờ",
    LeaderboardByFlagPayerCount: "#",
    LeaderboardByFlagPayerValuationPerHour: "V/H",
    LeaderboardByFlagPayerSwissMoney: "Thụy Sĩ",
    PlayerTradePriceFilter: "Bộ lọc giá",
    PlayerTradeFilterBetterThanMarket: "Tốt hơn thị trường",
    PlayerTradeFilterAll: "Tất cả",
    PlayerTradeFilterBestPrice: "Giá tốt nhất",
    ...
    BuildingSourceReset: "Đặt Lại",
    BuildingSourceSelecting: "Chạm Vào Bản Đồ...",
    ...
    BuildingSourceFallbackSkip: "Bỏ Qua",
    BuildingSourceFallbackDrain: "Hệ Thống Thoát Nước",
    BuildingSourceFallbackAuto: "Mới",
    ...
    RandomIsland: "Đảo ngẫu nhiên",
    RandomIslandBonus:
        "<li>Bản đồ được chọn ngẫu nhiên mỗi khi bạn bắt đầu</li><li>Kích thước bản đồ, kiểu lưới, các mỏ tài nguyên và các phần thưởng đặc biệt đều được tạo ngẫu nhiên</li><li>Có thời gian chờ 5 phút – mỗi lần làm mới chỉ có thể thực hiện sau ít nhất 5 phút kể từ lần trước</li>",
    RandomIslandBonusDesc: "Phần thưởng đặc biệt trên Đảo ngẫu nhiên sẽ được tạo lại mỗi khi bạn bắt đầu một ván chơi trên bản đồ đó",
    RandomIslandBonusCapacity: "%{building} có x%{multiplier} sức chứa",
    RandomIslandBonusProductivity: "%{building} có x%{multiplier} năng suất",
    RandomIslandBonusResources: "Mỏ tài nguyên trên bản đồ này: %{deposits}",
    ValuationPerActiveMinute: "Giá trị mỗi phút hoạt động",
    Perth: "Perth",
    GV: "Geothermal Vent",
    ...
    Water: "Nước",
    KansasCity: "Thành phố Kansas",
    Dam: "Đập thuỷ điện",
    DamDesc: "Đập thủy biến ô rỗng liền kề thành ô nước",
    Farmland: "Đất nông nghiệp",
    FarmlandDesc: "Sản xuất cây trồng trên ô nước",
    Storage: "Kho lưu trữ",
    Rice: "Gạo",
    Corn: "Bắp",
    Wheat: "Lúa mì",
    ...
    Sugarcane: "Mía đường",
    Vegetable: "Rau",
    FarmlandOfflineFarming: "Nông nghiệp Ngoại tuyến",
    ...
    Greenhouse: "Nhà kính",
    GreenhouseDesc: "Sản xuất một loại cây trồng mà bạn chọn",
    WaterEntityLevelTooHighDesc:
        "Cấp độ xây dựng của bạn cao hơn cấp độ đập thủy điện liền kề. Hãy nâng cấp đập thủy lực của bạn",
    AirLiquidizer: "Chất hóa lỏng không khí",
    ...
    Moderator: "Moderator",
    FlourMill: "Máy xay Bột mì",
    Flour: "Bột mì",
    FlourMillAdjustMix: "Điều chỉnh Hỗn hợp Bột mì",
    RiceFlour: "100% Gluten Free",
    RiceFlourDesc: "Flour mills consumes rice instead of wheat",
    Bread: "Bánh mì",
    Bakery: "Tiệm bánh mì",
    Fodder: "Thức ăn gia súc",
    FodderFactory: "Nhà máy thức ăn gia súc",
    ...
    Cake: "Bánh kem",
    ChooseARecipe: "Chọn công thức",
    ChickenFarm: "Trang trại gà",
    Chicken: "Gà",
    Egg: "Trứng",
    CowFarm: "Trang trại bò",
    Beef: "Thịt bò",
    Milk: "Sữa",
    DairyFactory: "Nhà máy chế biến sữa",
    Cheese: "Phô mai",
    Cookie: "Bánh quy",
    Butter: "Bơ",
    UnlockAtLevel: "Mở khoá tại cấp %{level}",
    FastFoodChain: "Chuỗi thức ăn nhanh",
    Burger: "Burger",
    Sandwich: "Sandwich",
    ...
    StartInANewCity: "Bắt Đầu Ở Một Thành Phố Mới ",
    ...
    PlayerTradeCancelYes: "Hủy giao dịch",
    PlayerTradeCancelNo: "Đừng Hủy",
    ...
    SettingsShowInToolbar: "Hiển thị trong thanh công cụ",
    AccountVerification: "Xác minh",
    AccountAuthenticated: "Đã xác thực",
    AccountNotAuthenticated: "Không được xác thực",
    AccountTrusted: "Tài khoản đáng tin cậy",
    AccountLimited: "Tài khoản đã giới hạn",
    AntiCheatPass: "Chống gian lận Thông qua",
    AntiCheatFail: "Chống gian lận Thất bại",
    ...
    GameSettingGeneral: "Tổng quát",
    GameSettingDisplay: "Hiển thị",
    GameSettingHideElements: "Hide From View",
    GameSettingAudio: "Âm thanh",
    GameSettingGameplay: "Trò chơi",
    GameSettingSinglePlayerMode: "Chế độ chơi đơn",
